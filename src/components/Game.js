...
class Game extends React.Component {
  ...
  componentDidMount = () =>
  {this.setCurrentTime()}
  //You need a () (ie. this.setCurrentTime() instead of this.setCurrentTime because the argument that Date takes in is a function setCurrentTime = new Date(Date.now())
